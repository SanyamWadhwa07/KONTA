// /**
//  * LEGACY: Add to Project button content script
//  * 
//  * ⚠️ DISABLED - Functionality migrated to:
//  * 1. Indicator hub "Add to Project" quick action (for new pages)
//  * 2. Project suggestion notifications (for related pages)
//  * 3. Quick add button in Projects sidebar
//  * 
//  * This content script previously injected a floating button on every page.
//  * All functionality is now in the unified notification hub or sidebar.
