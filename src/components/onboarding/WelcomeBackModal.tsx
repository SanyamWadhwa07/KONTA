      ...
      <DialogContent 
        ...
        <div className="flex flex-col items-center">
          ...
          <Button 
            ...
            className="font-normal h-10 mt-4 border-0 focus:outline-none focus:ring-0 active:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 rounded-full px-6 text-white"
